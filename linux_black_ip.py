...
def get_ip_details_selenium(ip):
    ...
    chrome_options.add_argument("user-agent='Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36'")  # 使用这个设置可以避免网站检测到你使用的是无界模式进行反抓取
